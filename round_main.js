class ChartPlotareaComponent extends HTMLElement {
    ...
    render() {
        ...
        this._series[0].dataPoints.forEach((dataPoint) => {
            this.rednerData(dataPoint.dataInfo);
        });
    }
    /**
    ...
    */
    renderData(dataInfo) {
        if (!dataInfo || dataInfo.hidden || dataInfo.outOfiViewport) {
            return;
        }
